...
namespace cAlgo.Indicators
{
    ...
    public class BelkhayatePolynomialRegression : Indicator
    {
        ...
        [Output("PRC", LineColor = "Gray", LineStyle = LineStyle.Lines)]
        public IndicatorDataSeries prc { get; set; }

        [Output("SQH", LineColor = "Transparent", LineStyle = LineStyle.Lines)]
        public IndicatorDataSeries sqh { get; set; }

        [Output("SQL", LineColor = "Transparent", LineStyle = LineStyle.Lines)]
        public IndicatorDataSeries sql { get; set; }

        [Output("SQL2", LineColor = "Blue", LineStyle = LineStyle.Lines)]
        public IndicatorDataSeries sql2 { get; set; }

        [Output("SQH2", LineColor = "Red", LineStyle = LineStyle.Lines)]
        public IndicatorDataSeries sqh2 { get; set; }

        [Output("SQL3", LineColor = "Transparent", LineStyle = LineStyle.Lines)]
        public IndicatorDataSeries sql3 { get; set; }

        [Output("SQH3", LineColor = "Transparent", LineStyle = LineStyle.Lines)]
